...
const navItems = [
    {
        section: 'Main', items: [
            { to: '/', icon: <img src={dashboard}/>, label: 'Dashboard' },
            { to: '/groups', icon: <img src={groupIcon}/>, label: 'Groups' },
            { to: '/expenses', icon: <img src={youOwe}/>, label: 'Expenses' },
            { to: '/settlements', icon: <img src={settlement}/>, label: 'Settlements' },
        ]
    }
];
